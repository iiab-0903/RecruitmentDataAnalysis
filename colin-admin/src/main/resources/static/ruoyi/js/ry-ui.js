...
(function ($) {
    $.extend({
        ...
        operate: {
            ...
            // 详细信息
            xmlDetail: function(id, width, height) {
                table.set();
                var _url = $.operate.detailUrl(id);
                var options = {
                    title: table.options.modalName + "详细",
                    ...
                    yes: function (index, layero) {
                        var iframeWin = layero.find('iframe')[0];
                        iframeWin.contentWindow.search();
                    },
            ...
            xmlAdd: function(width,height) {
                console.log(width,height)
                table.set();
                $.modal.open("添加" + table.options.modalName, $.operate.addUrl(''),width,height);
            },
            // 添加信息，以tab页展现
            addTab: function (id) {
                table.set();
